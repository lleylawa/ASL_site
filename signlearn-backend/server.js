...
// API-маршрут для сохранения результатов викторины
// API-маршрут для сохранения результатов викторины (ТЕПЕРЬ ЗАЩИЩЕН)
// Используем authenticateToken как второй аргумент
// API-маршрут для сохранения результатов викторины (ТЕПЕРЬ ЗАЩИЩЕН)
